...
# Tested on RPi2 debian version 7.8
...
FILE="$build_root/build/toolchain-rpi.cmake"
...
cmake -DCMAKE_TOOLCHAIN_FILE=$FILE -DcompileOption_C:STRING="--sysroot=$RPI_ROOT" $build_root
make --jobs=$CORES
